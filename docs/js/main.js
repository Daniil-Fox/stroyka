...
/* harmony import */ var _components_load_more_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/load-more.js */ "./src/js/components/load-more.js");
...
/* harmony import */ var _components_rating_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/rating.js */ "./src/js/components/rating.js");
...
/* harmony import */ var _components_filter_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/filter.js */ "./src/js/components/filter.js");
...
if (window.matchMedia("(max-width: 900px)").matches && dropdownItems.length > 0) {
...
if (window.matchMedia("(max-width: 900px)").matches && moreContainer.length > 0) {
...
swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper.use([swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Thumbs, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.EffectFade]);
...
galleryContainers.forEach(container => {
  ...
  const galleryThumbsSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper(galleryThumbs, {
    slidesPerView: 5,
    spaceBetween: 20,
    navigation: {
  ...
  const gallerySlider = new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper(gallery, {
    slidesPerView: 1,
    spaceBetween: 20,
    thumbs: {
...
const tabs = new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper(".single-prod__slider", {
  slidesPerView: "auto",
  spaceBetween: 6
});
const tabsContent = new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper(".single-prod__main", {
  slidesPerView: 1,
  spaceBetween: 20,
  effect: "fade",
  fadeEffect: {
...
const navSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper(".header__nav", {
  slidesPerView: "auto",
  spaceBetween: 20
});
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (dropdownContainers.length > 0) {
    dropdownContainers.forEach(dd => {
      ...
      ddHeader.addEventListener("click", e => {
        ...
        ddContent.style.maxHeight = isActive ? ddContent.scrollHeight + "px" : null;
      });
    ...
    fileAttach.forEach(fa => {
      ...
      input.addEventListener("change", e => {
        if (input.files.length > 0) {
          text.textContent = [...input.files].map(item => item.name).join(",");
        } else {
  ...
  if (pagination) {
    ...
    const adjustPagination = () => {
      ...
      let currentWidth = Array.from(items).reduce((sum, item) => sum + item.offsetWidth, 0);
      if (currentWidth > availableWidth) {
        ...
        currentWidth = Array.from(items).reduce((sum, item) => sum + (item.classList.contains("is-hidden") ? 0 : item.offsetWidth), 0);
